 ...
 */
  ...
  * @param {GetPlayerCombinedInfoRequestParams} infoRequestParameters
  * *REQUIRED* Flags for which pieces of info to return for the user.
  * @param {string} playFabId
  * *REQUIRED* PlayFabId of the user whose data will be returned
  */
  ...
  * @param {string} playFabId
  * *REQUIRED* user for whom statistics are being requested
  ...
  * *REQUIRED* Statistics to be updated with the provided values
  ...
  * @param {number} amount
  * *REQUIRED* Amount to be added to the character balance of the specified virtual currency. Maximum VC balance is Int32 (2,147,483,647). Any increase over this value will be discarded.
  * @param {string} characterId
  * *REQUIRED* Unique PlayFab assigned ID for a specific character owned by a user
  * @param {string} playFabId
  * *REQUIRED* PlayFab unique identifier of the user whose virtual currency balance is to be incremented.
  * @param {string} virtualCurrency
  * *REQUIRED* Name of the virtual currency which is to be incremented.
  */
  ...
  * @param {number} amount
  * *REQUIRED* Amount to be added to the user balance of the specified virtual currency. Maximum VC balance is Int32 (2,147,483,647). Any increase over this value will be discarded.
  * @param {string} playFabId
  * *REQUIRED* PlayFab unique identifier of the user whose virtual currency balance is to be increased.
  * @param {string} virtualCurrency
  * *REQUIRED* Name of the virtual currency which is to be incremented.
  */
  ...
  * *REQUIRED* Number of uses to consume from the item.
  * @param {string} itemInstanceId
  * *REQUIRED* Unique instance identifier of the item to be consumed.
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} characterId
  ...
  * *REQUIRED* The unique identifier of the Random Result Table to use.
  ...
  * @param {string[]} itemIds
  * *REQUIRED* Array of itemIds to grant to the user.
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} annotation
  * String detailing any additional information concerning this operation.
  ...
  * *REQUIRED* Array of items to grant and the users to whom the items are to be granted.
  * @param {string} catalogVersion
  * Catalog version from which items are to be granted.
  */
  ...
  * @param {string} itemInstanceId
  * *REQUIRED* Unique instance identifier of the item to be modified.
  * @param {string} playFabId
  * *REQUIRED* PlayFab unique identifier of the user whose item is being modified.
  * @param {number} usesToAdd
  * *REQUIRED* Number of uses to add to the item. Can be negative to remove uses.
  */
  ...
  * *REQUIRED* Unique identifier of the character that currently has the item.
  * @param {string} itemInstanceId
  * *REQUIRED* Unique PlayFab assigned instance identifier of the item
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} receivingCharacterId
  * *REQUIRED* Unique identifier of the character that will be receiving the item.
  */
  ...
  * *REQUIRED* Generated coupon code to redeem.
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} catalogVersion
  ...
  * *REQUIRED* Unique PlayFab identifier of the reported player.
  * @param {string} reporterId
  * *REQUIRED* PlayFabId of the reporting player.
  ...
  * *REQUIRED* Array of player items to revoke, between 1 and 25 items.
  */
  ...
  * @param {number} amount
  * *REQUIRED* Amount to be subtracted from the user balance of the specified virtual currency.
  * @param {string} characterId
  * *REQUIRED* Unique PlayFab assigned ID for a specific character owned by a user
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} virtualCurrency
  * *REQUIRED* Name of the virtual currency which is to be decremented.
  */
  ...
  * *REQUIRED* Amount to be subtracted from the user balance of the specified virtual currency.
  * @param {string} playFabId
  * *REQUIRED* PlayFab unique identifier of the user whose virtual currency balance is to be decreased.
  * @param {string} virtualCurrency
  * *REQUIRED* Name of the virtual currency which is to be decremented.
  */
  ...
  * *REQUIRED* ItemInstanceId of the container to unlock.
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} catalogVersion
  ...
  * *REQUIRED* Catalog ItemId of the container type to unlock.
  * @param {string} playFabId
  * *REQUIRED* Unique PlayFab assigned ID of the user on whom the operation will be performed.
  * @param {string} catalogVersion
  ...
  * *REQUIRED* The name of the CloudScript function to execute
  * @param {string} playFabId
  * *REQUIRED* The unique user identifier for the player on whose behalf the script is being run
  ...
  * @param {string[]} playFabIds
  * *REQUIRED* An array of unique PlayFab assigned ID of the user on whom the operation will be performed.
 ...
 */
  ...
  * @param {string} sharedGroupId
  * *REQUIRED* Unique identifier for the shared group.
  */
  ...
  * @param {string[]} keys
  * *REQUIRED* array of keys to get back data from the Publisher data blob, set by the admin tools
  */
